...
println("✅ R DLLs preloaded successfully")
...
xi_cur = 15
xi_can = 12  # Lower value to create rejection probability
n_samples = 1000
...
if julia_std == 0 && r_std == 0
    ...
    if pass
        println("✅ PASS - Both implementations give identical deterministic results")
    else
        println("❌ FAIL - Different deterministic results")
    end
else
